...
// Images data for Paulo Cezar
const images = [
  {
    src: '/1.JPG',
    alt: 'Imagem 1',
    title: 'Fotografia do Projeto'
  },
  {
    src: '/2.JPG',
    alt: 'Imagem 2',
  ...
  },
  {
    src: '/OrtoOut.jpg',
    alt: 'Ortomosaico',
    title: 'Ortomosaico do Projeto'
  }
];

// Projects data for Paulo Cezar
const projects = [
  {
    title: 'Projeto Arquitetônico',
    description: 'Desenvolvimento do projeto arquitetônico completo da Paulo Cezar',
    status: 'ativo' as const,
    location: 'Porto Velho, RO',
    type: 'arquitetura' as const,
    files: [
      { name: 'ARQ 1.pdf', path: '/ARQ 1.pdf' },
      { name: 'ARQ 2.pdf', path: '/ARQ 2.pdf' }
    ],
    professional: {
  ...
  },
  {
    ...
    description: 'Sistema estrutural completo da Paulo Cezar',
    status: 'ativo' as const,
    location: 'Porto Velho, RO',
    type: 'estrutural' as const,
    files: [
      { name: 'Fundação.pdf', path: '/Fundação.pdf' },
      { name: 'Viga Baldrame.pdf', path: '/Viga Baldrame.pdf' },
      { name: 'Pilar Térreo e Intermediário.pdf', path: '/Pilar Térreo e Intermediário.pdf' },
      { name: 'Forma Pav.Térreo.pdf', path: '/Forma Pav.Térreo.pdf' }
    ],
    professional: {
      name: 'Rodrigo Bonfim Lopes',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-yellow-50 to-gray-100">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-800 shadow-2xl overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto relative z-10 px-2 sm:px-4 lg:px-8">
          <div className="relative py-3 sm:py-6 lg:py-8">
            {/* Layout responsivo para mobile */}
            <div className="flex flex-col lg:block">
              {/* Logo BIMTECH e Nome da Empresa - Mobile: Topo, Desktop: Canto Esquerdo */}
              <div className="flex justify-center lg:absolute lg:left-0 lg:top-6 lg:justify-start mb-3 sm:mb-4 lg:mb-0">
                <div className="flex items-center gap-1.5 sm:gap-3 lg:gap-4 group">
                  <div className="relative">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden border-2 border-yellow-300 transform group-hover:scale-105 transition-all duration-300">
                      <img 
                        src="/BIMTECH.jpg" 
                        alt="BIMTECH Logo" 
                        className="w-full h-full object-cover rounded-md sm:rounded-lg lg:rounded-xl"
                      />
                    </div>
                    {/* Efeito de brilho na logo */}
                    <div className="absolute -inset-0.5 sm:-inset-1 bg-gradient-to-r from-yellow-400/30 to-yellow-500/30 rounded-lg sm:rounded-xl lg:rounded-2xl blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </div>
                  <div className="space-y-0 sm:space-y-0.5 lg:space-y-1">
              ...
              <div className="flex justify-center items-center min-h-[60px] sm:min-h-[100px] lg:min-h-[120px]">
                <div className="text-center relative group px-1 sm:px-4">
                  <div className="relative">
                    <h1 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-center relative leading-tight">
                      ...
                      <br />
                      <span className="text-xs sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-yellow-300 font-bold mt-0.5 sm:mt-2 lg:mt-3 block tracking-wide">
                      </span>
                    </h1>
                    
                    {/* Efeitos de brilho responsivos */}
                    <div className="absolute -inset-2 sm:-inset-6 lg:-inset-8 bg-gradient-to-r from-yellow-400/10 via-yellow-300/20 to-yellow-500/10 rounded-xl sm:rounded-3xl blur-lg sm:blur-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-500 animate-pulse"></div>
                    <div className="absolute -inset-1 sm:-inset-3 lg:-inset-4 bg-gradient-to-r from-yellow-400/5 via-yellow-300/10 to-yellow-500/5 rounded-lg sm:rounded-2xl blur-md sm:blur-xl opacity-40 group-hover:opacity-60 transition-opacity duration-300"></div>
                    
                    {/* Linha de destaque responsiva */}
                    <div className="absolute -bottom-2 sm:-bottom-4 lg:-bottom-6 left-1/2 transform -translate-x-1/2 w-16 sm:w-32 md:w-40 lg:w-48 h-0.5 sm:h-1.5 lg:h-2 bg-gradient-to-r from-transparent via-yellow-400 to-transparent rounded-full shadow-lg shadow-yellow-400/30"></div>
                    <div className="absolute -bottom-1 sm:-bottom-3 lg:-bottom-5 left-1/2 transform -translate-x-1/2 w-12 sm:w-20 md:w-24 lg:w-32 h-0.5 sm:h-1 bg-gradient-to-r from-transparent via-yellow-300 to-transparent rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          {activeTab === 'home' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-2xl font-bold text-gray-800 mb-2">Bem-vindo ao Dashboard do Paulo Cezar</h2>
                <p className="text-sm sm:text-base text-gray-600">
                  Explore os projetos e documentos da Paulo Cezar. Navegue pelas abas para acessar diferentes funcionalidades.
                </p>
              </div>

              {/* Galeria de Imagens */}
              <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Fotografias do Projeto</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                  Explore o registro fotográfico do projeto Paulo Cezar. Esta galeria apresenta as imagens do projeto em desenvolvimento. Clique nas imagens para visualização em tela cheia.
                </p>
          ...
          {activeTab === 'projetos' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-2xl font-bold text-gray-800 mb-2">Projetos do Paulo Cezar</h2>
                <p className="text-sm sm:text-base text-gray-600">
          ...
          {activeTab === 'documentos' && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
                <h2 className="text-lg sm:text-2xl font-bold text-gray-800 mb-2">Documentos de Regularização</h2>
                <p className="text-xs sm:text-sm text-gray-600">
                  <strong>Inscrição do Imóvel:</strong> 01220510265001
                </p>
                <p className="text-xs sm:text-sm text-gray-600">
                  <strong>Endereço:</strong> Avenida José Vieira Caula, N 641, Bairro Esperança da Comunidade
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 max-w-7xl mx-auto">
              ...
              {/* Card do Licenciamento de Obra */}
              <div className="w-full">
                <DocumentCard
                  title="Licenciamento de Obra"
                  type="licenca"
                  checklist={[
                    {
                      id: "requerimento_licenca",
                      text: "Requerimento padrão com Declaração, totalmente preenchido e assinado",
                      required: true
                    },
                    {
                      id: "certidao_negativa_licenca",
                      text: "Certidão Negativa de Débitos do Imóvel atualizada - IPTU",
                      required: true
                    },
                    {
                      id: "comprovacao_propriedade_licenca",
                      text: "Documentos de comprovação de propriedade do terreno",
                      required: true
                    },
                    {
                      id: "documentos_pessoais_licenca",
                      text: "Documentos pessoais do Interessado e Procurador",
                      required: true
                    },
                    {
                      id: "projeto_arquitetonico_licenca",
                      text: "03 jogos de Projeto Arquitetônico completo",
                      required: true
                    },
                    {
                      id: "art_licenca",
                      text: "Cópia das ART (autenticada pelo CREA) dos profissionais responsáveis",
                      required: true
                    },
                    {
                      id: "licenca_ambiental_licenca",
                      text: "Licença Ambiental de Operação emitida pelo Órgão Ambiental",
                      required: true
                    }
                  ]}
                />
